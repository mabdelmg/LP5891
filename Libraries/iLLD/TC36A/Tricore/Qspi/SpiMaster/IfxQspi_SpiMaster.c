...
{
    {
        ...
        chConfig.mode.shiftClock      = econ.B.CPH == 0 ? SpiIf_ShiftClock_shiftTransmitDataOnLeadingEdge : SpiIf_ShiftClock_shiftTransmitDataOnTrailingEdge;
...
//    IfxQspi_SpiMaster_setChannelBaudrate(chHandle,1000000);
    IfxQspi_run(qspiSFR);
}
